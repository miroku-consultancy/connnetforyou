...
// const imageBase = "https://www.connectfree4u.com/images/shops";
// const fallbackLogo = `${imageBase}/logo.png`;
...
//           const fallbackImages = extensions.map(ext => `${imageBase}/${shop}.${ext}`).concat(fallbackLogo);
//           let imgIndex = 0;
...
//                   onError={(e) => {
//                     imgIndex++;
//                     if (imgIndex < fallbackImages.length) {
//                       e.currentTarget.onerror = null;
//                       e.currentTarget.src = fallbackImages[imgIndex];
//                     }
//                   }}
//                 />
//               </div>
